...
- Four security groups are present: `default` allowing intra-cluster communication, `SSH` allowing external access via SSH, `HTTPS` allowing access for Open OnDemand and `HTTP` for certbot.
