...
Where `vault_elasticsearch_admin_password` is a variable containing the actual password. This is generated by the `generate-passwords.yml` adhoc playbook (see [README.md](../README.md#creating-a-slurm-appliance)).
...
| kibanaserver  | <vault_elasticsearch_kibana_password> | Internal kibana user (not currently used) |
