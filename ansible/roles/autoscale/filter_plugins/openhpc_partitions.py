...
def modify_autoscale_partitions(partitions):
    """ TODO: docs
    """
    ...
    for part in partitions:
        for group in part.get('groups', [part]):
            ...
            extra_nodes = group.get('extra_nodes', [])
            ...
            if 'cloud_nodes' in group:
                ...
                cloud_nodes = f'NodeName={cloud_names} State=CLOUD Features={features}'

                extra_nodes.append(cloud_nodes)
