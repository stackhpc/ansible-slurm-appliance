...
[control]
${control.name} instance_id=${control.id} ansible_host=${[for n in control.network: n.fixed_ip_v4 if n.access_network][0]} networks='${jsonencode({for net in control.network: net.name => net.fixed_ip_v4 })}'
...
${compute.name} instance_id=${compute.id} ansible_host=${[for n in compute.network: n.fixed_ip_v4 if n.access_network][0]} networks='${jsonencode({for net in compute.network: net.name => net.fixed_ip_v4 })}'
%{ endfor ~}
