# Terraform-Example cluster

Example demonstrating how to provision infrastructure with terraform
...
resources relative the environment directory.
    ...
    . environments/terraform-example/activate
...
- Activate the virtualenv and create the instances:
      ...
      . venv/bin/activate
      cd environments/terraform-example/
      terraform apply
